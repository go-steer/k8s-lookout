---
title: "lookout triage spec"
description: "Read ONE resource's spec: kubectl describe, but token-dense, secret-safe, and default-elided — healthy conditions are omitted."
---
...
| --- | --- | --- | --- |
| `--diff` | bool | — | diff against the previous graph-history revision — requires a sentinel store; lands in M3 |
