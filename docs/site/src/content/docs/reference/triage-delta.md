...
description: "Every abnormal object in one scan — the first call for \"anything wrong in this cluster?\": broken/pending pods, stalled rollouts, node pressure/NPD/preemption, gridlocked PDBs, degraded kube-system add-ons, quotas at their limits."
---
