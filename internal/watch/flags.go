...
var knownSources = []string{k8sevents.Name, objectstate.Name, rollout.Name, workload.Name, saturation.Name, degradation.Name, expiry.Name, capacity.Name, ingress.Name, quota.Name, notifications.Name, tokenburn.Name}
