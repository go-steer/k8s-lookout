...
func TestDispatchSignal_ForecastExactWireShape(t *testing.T) {
	...
	want := `{"kind":"saturation.forecast","reason":"forecast_memory","namespace":"prod","kind_of_object":"Pod","name":"web-1","container":"app","uid":"u1/app","message":"memory saturation forecast for web-1: current=980.0MiB limit=1.0GiB slope_per_min=3.2MiB — limit reached in ~14m at the observed trend (180 samples over 1h30m0s)","count":1,"first_seen":"2026-07-25T10:00:00Z","last_seen":"2026-07-25T10:00:00Z","cluster":"prod-us-central1","context":{"node":"node-1"},"forecast":{"eta":"2026-07-25T10:14:00Z","confidence_basis":"linear-90m-window"}}`
